...
2. 占位内容：vault_read `元数据/Compass 配置.md`，标记空白的 `birthdate`；vault_read `03 规划/人生主题.md` 与 `核心价值观.md`，标记仍保留“请在此写下你的生活主题”或“**价值一**”等模板文字的笔记；vault_read `03 规划/理想一周.md`，标记 `example: true`；vault_read `08 任务/任务总表.md`，标记尚未完成的设置向导任务。
