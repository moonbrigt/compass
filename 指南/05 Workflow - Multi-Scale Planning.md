...
| 层级 | 笔记 | 模板 | 回顾频率 |
| --- | --- | --- | --- |
| 角色与价值观 | `03 规划/Life Theme.md`、`03 规划/Core Values.md`（内含角色表） | 手工维护 | 静修时，每 90 天 |
| 季度 | `01 日记/季度/YYYY-QN.md` | `模板/Quarterly Note.md` | 静修时，每周略读 |
| 每周 | `01 日记/每周/gggg-Www.md` | `模板/Weekly Note.md` | 周日或周一规划，周五复盘 |
| 每日 | `01 日记/每日/YYYY-MM-DD.md` | `模板/Daily Note.md` | 早上与晚间 |
...
选三项与季度意向一致的每周意向；查看本周到期任务；周五通过 `元数据/视图/week.js` 查看每日努力分数、习惯记录与收获。
